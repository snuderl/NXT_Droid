...
public class JostickView extends View {
	...
	private JostickMovedListener listener;
	...
	public JostickView(Context context) {
		super(context);
		initJoystickView();
	}

	public JostickView(Context context, AttributeSet attrs) {
		super(context, attrs);
		initJoystickView();
	}

	public JostickView(Context context, AttributeSet attrs, int defStyle) {
	...
	public void setOnJostickMovedListener(JostickMovedListener listener) {
